    ...
    def _RealGetContents(self):
        ...
        while total < size_cd:
            ...
            if flags & 0x800:
                ...
                try:
                    filename = filename.decode('utf-8')  # 原始源码
                except:
                    filename = filename.decode('gbk')  # 修改部分
            else:
                # Historical ZIP filename encoding
                filename = filename.decode('cp437')  # 原始源码
                # filename = filename.decode('gbk')  # 修改部分
    ...
    def open(self, name, mode="r", pwd=None):
        ...
        try:
            ...
            if zinfo.flag_bits & 0x800:
                # UTF-8 filename
                try:
                    fname_str = fname.decode("utf-8")  # 源码
                except:
                    fname_str = fname.decode("gbk")  # 修改部分
            else:
